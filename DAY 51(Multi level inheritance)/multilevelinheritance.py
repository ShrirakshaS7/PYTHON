...
#1 WAP To display student name and marks and pass or fail status based on marks
class student:
    def get_name(self):
...
#2 WAP to display bankname,balance and perform deposit and withdraw operations
class Bank:
    def bank_name(self):
        self.bname='ICICI'
...
#3 WAP to display ename,empno,salary,deptname and project name, project id
class employee:
